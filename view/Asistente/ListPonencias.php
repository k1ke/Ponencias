...
<p>Seleccione el recuadro de la(s) ponencia(s) a la(s) que asistir&aacute;</p>


<form id="list" name="deleteItems" action="PonenciasAll.php?action=sendmail" method="post">
	<table>
	<tr>
	...
	<!--En esta parte se le enviara un correo al asistente confirmando sus asistencias a 
		las ponencias seleccionadas-->
